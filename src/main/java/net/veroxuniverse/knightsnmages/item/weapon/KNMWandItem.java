...
import net.veroxuniverse.knightsnmages.item.weapon.client.EliteWandRenderer;
...
public class KNMWandItem extends SwordItem implements ICasterTool, GeoItem, IManaDiscountEquipment {
    public AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);

    public KNMWandItem(Tier iItemTier, int baseDamage, float baseAttackSpeed) {
        this(iItemTier, baseDamage, baseAttackSpeed, defaultItemProperties().stacksTo(1));
    }

    public KNMWandItem(Tier iItemTier, int baseDamage, float baseAttackSpeed, Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new EliteWandRenderer();
